...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_train_steps", type=int, default=1000000, help="Maximum number of training steps")
    ...
    parser.add_argument("--algorithm", type=str, default="RMFQ", help="QMIX or VDN")
    ...
    parser.add_argument('--env_name', type=str, default='tiger_deer_v4')  #['3m', '8m', '2s3z']
    ...
    # save path
    parser.add_argument('--save_path', type=str, default='MFQ_tiger_deer/results_711')
